...
/**
 * Implementa el filtro de tipo numeric
 * @author katsu
 */
public class NumericFilter extends FilterRequest {

    private Number value;

    public NumericFilter(Number value, String fieldName, ComparisonType operation,int index) {
