...
Ext.contramed.DoseToolbar = Ext.extend(Ext.Toolbar, {
    ...
    initComponent: function() {
        ...
        this.items.push('->');
        this.addButton = new Ext.contramed.BarcodeButton({
            height: 30,
            scope: this,
            nonStopRead: true,
            autoLoad: true,
        ...
        this.addButton.setTooltip('A&ntilde;adir dosis');

        this.items.push(this.addButton);
        if (this.removeText) {
            this.items.push('-');
            this.removeButton = new Ext.contramed.BarcodeButton({
                height: 30,
                scope: this,
                nonStopRead: true,
                iconCls:'barcode',
            ...
            this.removeButton.setTooltip('Eliminar dosis');
