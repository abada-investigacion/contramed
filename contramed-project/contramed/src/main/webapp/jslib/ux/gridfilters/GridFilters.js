...
*/
    ...
    getFilterData : function () {
        var filters = [], i, len;
        var fields = this.grid.getStore().fields;
        ...
        this.filters.each(function (f) {
            if (f.active) {                
                ...
                for (i = 0, len = d.length; i < len; i++) {
                    //alert(fields[f.dataIndex]);
                    if (fields.map[f.dataIndex].mapping)
                        auxField=fields.map[f.dataIndex].mapping;
                    else
                        auxField=f.dataIndex;
                    filters.push({
                        field: auxField,
                        data: d[i]
                    });
