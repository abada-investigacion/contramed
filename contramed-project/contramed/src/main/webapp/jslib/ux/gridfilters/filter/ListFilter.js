...
filter : [{"type":"list","value":"small,medium","field":"size"}]
    ...
    getSerialArgs : function () {
        var args;
        if (!this.enumType)
            args= {type: 'list', value: this.phpMode ? this.getValue().join(',') : this.getValue()};
        else
            args= {type: 'list', value: this.phpMode ? this.getValue().join(',') : this.getValue(),enumType: this.enumType};
        return args;
    },
