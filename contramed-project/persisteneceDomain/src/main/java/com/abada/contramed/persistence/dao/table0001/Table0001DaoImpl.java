package com.abada.contramed.persistence.dao.table0001;
...
public class Table0001DaoImpl extends JpaDaoSupport implements Table0001Dao {
    ...
    public List<Table0001> findByCode(String code) {
        ...
        return this.getJpaTemplate().findByNamedQueryAndNamedParams("Table0001.findByCode", parametros);
    }
}
