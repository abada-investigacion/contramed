package com.abada.contramed.persistence.dao.templatesMedication;
...
public class TemplatesMedicationDaoImpl extends JpaDaoSupport implements TemplatesMedicationDao {
    ...
    @Transactional(readOnly = true)
    @Override
    public List<TemplatesMedication> loadAll(GridRequest_Extjs_v3 filters) {
    ...
    public List<TemplatesMedication> listAll() {
        List<TemplatesMedication> tempmed = this.getJpaTemplate().find("from TemplatesMedication t ORDER BY Template ASC");
        return tempmed;
    }
    ...
    public void updateTemplatesMedication(Long idtemplatesmedication, String template, String uuid, String uuidStyle) throws Exception {
        ...
        try{
        TemplatesMedication temp = (TemplatesMedication) this.getJpaTemplate().find(TemplatesMedication.class, new Long(idtemplatesmedication));
