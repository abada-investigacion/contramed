...
public class TimingRangeDaoImpl extends JpaDaoSupport implements TimingRangeDao {
    ...
    public List<TimingRange> listTimingRange() {
        List<TimingRange> result = (List<TimingRange>) this.getJpaTemplate().findByNamedQuery("TimingRange.findAll");
        return result;
    }
    ...
    public void insertTimingRange(Date startTime, Date endTime, String name) {
        ...
        tr.setName(name);
        this.getJpaTemplate().persist(tr);
    }
    ...
    public void updateTimingRange(Date startTime, Date endTime, String name, Long idtimingRange) {
        ...
        TimingRange tr = (TimingRange) this.getJpaTemplate().find(TimingRange.class, new Long(idtimingRange));
    ...
    public void removeTimingRange(Long timingRange) {
        ...
        TimingRange tr = (TimingRange) this.getJpaTemplate().find(TimingRange.class, new Long(timingRange));
        this.getJpaTemplate().remove(tr);
    }
    ...
    public List<TimingRange> findByIdtimingRange(Long idtimingRange) {
        ...
        return this.getJpaTemplate().findByNamedQueryAndNamedParams("TimingRange.findByIdtimingRange", parametros);
    }
}
