 ...
 * @author katsu
 */
public class NoThreatmentException extends WebContramedException{
    ...
    public NoThreatmentException(Dose dose,Patient patient,Date startTime,Date endTime,TreatmentActionMode mode){
        super("No medicamentos pautados de "+startTime+" a "+endTime);
    ...
    public TypeIncidence getType() {
        return TypeIncidence.NO_THREATMENT;
    }

    @Override
    public String getFullMessage() {
        return "No medicamentos pautados de "+startTime+" a "+endTime;
    }
