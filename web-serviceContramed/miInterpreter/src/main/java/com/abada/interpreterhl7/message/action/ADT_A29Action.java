 ...
 * @author david
 *
 * Borrar un historial clinico
 */
public class ADT_A29Action implements MessageAction {

    private static final Log logger = LogFactory.getLog(ADT_A29Action.class);
    ...
    /***
     * borrado de un paciente de nuestra base de datos
     * @param message
     * @throws HL7Exception
     */
    public void exec(Message message) throws HL7Exception {
        ...
        if (patient.getExitus() != null) {
            patientDao.deleteexitus(patient.getPatientIdList(), patient.getExitus());
        } else {
            patientDao.deletepatientId(patient.getPatientIdList());
        }
    }

    /**
     * return the code of message Action ADT_A29
     * @return
     */
    ...
    /**
     * return Trigger Event of message Action ADT_A29
     * @return
     */
    ...
    /**
     * return the structure of message  Action ADT_A29
     * @return
     */
